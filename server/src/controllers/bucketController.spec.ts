...
import type { iBucket } from "../common/types";
...
describe("bucketController", () => {
    describe("listByUserId", () => {
        it('should call the correct repo method', async () => {
            await bucketController.listByUserId("test-user-id");
    ...
    describe("listByUserIdWithMonthSummary", () => {
        it('should call the correct repo method', async () => {
            await bucketController.listByUserIdWithMonthSummary("test-user-id", { month: 1, year: 2024 });
    ...
    describe("create", () => {
        it('should call the correct repo method', async () => {
            ...
            await bucketController.create(testBucket);
    ...
    describe("getBucketById", () => {
        it('should call the correct repo method', async () => {
            await bucketController.getBucketById("test-bucket-1");
    ...
    describe("updateBucketById", () => {
        ...
        it('should call the correct repo method', async () => {
            await bucketController.updateBucketById("test-bucket-id", updateBucket);
    ...
    describe("deleteBucketById", () => {
        it('should call the correct repo method', async () => {
            await bucketController.deleteBucketById("test-bucket-id");
